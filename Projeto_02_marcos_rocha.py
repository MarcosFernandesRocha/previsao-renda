...
st.markdown('A análise das variáveis qualitativas evidencia a correlação da variável renda com a variável de posse de veículo. As demais variáveis não representam correlação relevante.')
